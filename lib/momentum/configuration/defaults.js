...
module.exports = () => {
  ...
  return {
    ...
    processModules: {
      config: [],
      all:    ['globals', 'services', 'database', 'controllers', 'api', 'server'],
      api:    ['globals', 'services', 'database', 'controllers', 'api'],
      repl:   ['globals', 'services', 'database']
    },
    ...
    paths: {
      ...
      decorators:  path.resolve(appPath, server, 'decorators'),
